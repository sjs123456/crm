# Generated by Django 3.0.8 on 2020-07-25 20:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('classType', models.SmallIntegerField(choices=[(0, '面授(脱产)'), (1, '面授(周末)'), (2, '网络班')], verbose_name='班级类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.SmallIntegerField(choices=[(0, '转介绍'), (1, 'QQ群'), (2, '官网'), (3, '51CTO'), (4, '百度推广'), (5, '知乎'), (6, '市场推广')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(to='CRM.Role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendance', models.SmallIntegerField(choices=[(0, '已签到'), (1, '迟到'), (2, '缺勤'), (3, '早退')], default=0, verbose_name='出勤状况')),
                ('score', models.SmallIntegerField(choices=[(100, 'A+'), (90, 'A+'), (85, 'B+'), (80, 'B'), (75, 'B-'), (70, 'C+'), (60, 'C'), (40, 'C-'), (-50, 'D'), (-100, 'COPY'), (0, 'N/A')], verbose_name='分数情况')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('courese_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRM.CourseRecord')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('consultent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRM.UserProfile')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRM.Customer')),
            ],
        ),
        migrations.AddField(
